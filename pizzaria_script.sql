...
CREATE TABLE IF NOT EXISTS `S201exercici2`.`Productos` (
  ...
  PRIMARY KEY (`Productos_id`, `Bebida_Bebida_id`, `Hamburguesa_Hamburguesa_id`, `Pizza_Pizza_id`, `Pizza_Categoria_Categoria_id`),
  INDEX `fk_Productos_Bebida1_idx` (`Bebida_Bebida_id` ASC) VISIBLE,
  INDEX `fk_Productos_Hamburguesa1_idx` (`Hamburguesa_Hamburguesa_id` ASC) VISIBLE,
  INDEX `fk_Productos_Pizza1_idx` (`Pizza_Pizza_id` ASC, `Pizza_Categoria_Categoria_id` ASC) VISIBLE,
  CONSTRAINT `fk_Productos_Bebida1`
    FOREIGN KEY (`Bebida_Bebida_id`)
    REFERENCES `S201exercici2`.`Bebida` (`Bebida_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Productos_Hamburguesa1`
...
-- -----------------------------------------------------
-- Table `S201exercici2`.`Pedido_has_Productos`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `S201exercici2`.`Pedido_has_Productos` (
  `Pedido_Pedido_id` INT NOT NULL,
  `Pedido_Cliente_Cliente_id` INT NOT NULL,
  `Productos_Productos_id` INT NOT NULL,
  PRIMARY KEY (`Pedido_Pedido_id`, `Pedido_Cliente_Cliente_id`, `Productos_Productos_id`),
  INDEX `fk_Pedido_has_Productos_Productos1_idx` (`Productos_Productos_id` ASC) VISIBLE,
  INDEX `fk_Pedido_has_Productos_Pedido1_idx` (`Pedido_Pedido_id` ASC, `Pedido_Cliente_Cliente_id` ASC) VISIBLE,
  CONSTRAINT `fk_Pedido_has_Productos_Pedido1`
    FOREIGN KEY (`Pedido_Pedido_id` , `Pedido_Cliente_Cliente_id`)
    REFERENCES `S201exercici2`.`Pedido` (`Pedido_id` , `Cliente_Cliente_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
